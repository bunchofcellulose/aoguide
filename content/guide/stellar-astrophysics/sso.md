...
It has at least 79 known moons, including the four largest, known as the Galilean moons: Io, Europa, Ganymede, and Callisto. Jupiter has a day length of about 9.9 hours and takes about 11.9 Earth years to complete one orbit around the Sun. Io's surface is covered in active volcanoes, while Europa is believed to have a subsurface ocean beneath its icy crust, making it a candidate for potential extraterrestrial life. Ganymede is the largest moon in the Solar System and has its own magnetic field, while Callisto is heavily cratered and has a thin atmosphere. Io's main source of heat is tidal heating due to its gravitational interaction with Jupiter and the other Galilean moons.
...
A dwarf planet is one which satisfies the first two conditions, but not the third. The IAU currently recognizes five dwarf planets: Ceres, Pluto, Haumea, Makemake, and Eris.
