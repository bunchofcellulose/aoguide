...
The geometry of the sphere is made up of great circles, small circles and arcs of these figures. For convenience, the radius of the sphere is chosen to be unity. Thus distances along great circles are often measured as angles the arcs subtend at the center.

A great circle is defined to be the intersection with the sphere of a plane containing the centre of the sphere. Thus any circle on the sphere whose center coincides with the center of the sphere is a great circle. Since the centre is equidistant from all points on the sphere, the figure of intersection must be a circle by definition. If the plane does not pass through the centre, the intersection is a small circle. The great circles are the largest circles on the sphere and divide it into two equal hemispheres. The small circles are smaller than the great circles and do not divide the sphere into equal parts.
...
The geodetic latitude $\phi$ is and the geocentric latitude $\theta$ are related to each other by the ellipticity $f$ as follows:
...
{{< svg "pos/departure.svg" "Departure between two points" "Distance along the small circle parallel to the qquator is the departure between AB, distance along the great circle is the shortest distance between AB" >}}
...
A nautical mile is the great circle distance subtending an angle of one minute of arc at the centre of the Earth. A knot is a speed of one nautical mile per hour.
...
The celestial sphere is an imaginary sphere of infinite radius, concentric with the Earth, on which all celestial objects appear to be projected. The Earth is at the centre and the celestial objects are at the surface of the sphere. This is a useful tool as it allows us to represent the positions of celestial objects on a two-dimensional surface, without considering their distances from the observer.
...
{{< tabs items="P3,Solution" >}}
    ...
    Find the difference between the departure and the great circle distance and between two points on the Earth, having the same latitude $\phi$ and longitude difference $\Delta \lambda$. Find the result in the limit of small $\Delta \lambda$.
    ...
    Thus the difference between the departure and the great circle distance is thus
...
{{< tabs items="P4,Solution" >}}
    ...
    A ship is travelling at 20 knots from Vizhinjam International Seaport ($8^\circ 22'$ N, $76^\circ 57'$ E) to Port of Colombo ($6^\circ 57'$ N, $79^\circ 51'$ E). Find the time taken to reach Colombo, assuming the ship travels along the great circle. Also find the the bearing angle at the start of the journey.
